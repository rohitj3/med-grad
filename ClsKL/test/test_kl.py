...
def set_args():
    ...
    parser.add_argument('--model_dir',             type=str, default='../../data/ClsKLData/models/cmpLoss/vgg-19-SGD-1/0/')
    parser.add_argument('--best_model_name',       type=str, default='00-0.182-0.267-1.077.pth')
...
if __name__ == "__main__":
    ...
    #gen_vis_loc(args, args.phase, dset_loaders, dset_size, args.save_dir)
    #gen_grad_cam(args, args.phase, dset_loaders, dset_size, args.save_dir)
